...
// CORS setup
const corsOptions = {
  origin: ['https://mint.puffdog.vip'], // your frontend domain
...
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', 'https://mint.puffdog.vip');
...
// Replace the airdrop endpoint in your backend (around line 288)
...
app.post('/api/createCollection', async (req, res) => {
  try {
    ...
    const response = await createNft(umi, {
      ...
      symbol:'PUFF',
      uri: 'https://peach-binding-gamefowl-763.mypinata.cloud/ipfs/bafkreid2ylio7ltgbzljqsbmf4lr4yrbvivbezd6j4hgeozh7qjbxzgdhu',
